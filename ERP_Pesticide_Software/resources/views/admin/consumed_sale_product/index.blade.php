            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ __('Consumed /Sale Product') }}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            //active
            $('#consumed_sale_product').addClass('active');
            $('#ajax-crud-datatable').DataTable({
                ...
                // "bSort" : false,
                fixedHeader: true,
                ajax: " {{ route('admin.consumed_sale_product.index') }}",
                columns: [
                    {
                        data: 'product_code',
                        name: 'product_code'
