            ...
            <div class="card-body">
                <div class="row">
                            ...
                            <tbody>
                                ...
                                @foreach ($recorde->data as $key=>$value)
                                    <tr class="border">
                                        ...
                                        <td>{{get_product($value['product_id'])->product_code }}</td>
                                         <td>{{ number_format($value['purchasing_price']) }}</td>
                   ...
                   <hr class="col-12" style="margin-top: 10vh">
                    ...
                    <p class="col-3 text-center"> {{__(number_format($total_amount))}}</p>
                    <hr class="col-12">
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <p class="col-12 text-left mb-5"><b>Total Expense: </b>{{__(number_format($recorde->purchasing_expense,2))}}</p>
                    <p class="col-12 text-left"><b>Total Amount: </b>{{__(number_format($total_amount+$recorde->purchasing_expense,2))}}</p>
